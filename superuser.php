...
<div class="w3-top">
 <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
  ...
  <li><a href="#" class="w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>Aula Virtual</a></li>
  ...
  <li class="w3-hide-small w3-right"><a href="#" class="w3-padding-large w3-hover-white" title="My Account"><img src="Images\argentina_okey.png" class="w3-circle" style="height:25px;width:25px" alt="Avatar"></a></li>
 </ul>
</div>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         ...
         <p class="w3-center"><img src="Images\argentina_okey.png" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Super-usuario</p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Argentina </p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> <?php echo date('Y'); ?></p>
        </div>
      </div>
      <br>
      ...
      <div class="w3-card-2 w3-round w3-white w3-hide-small">
        <div class="w3-container">
          ...
          <p>
            ...
            <span class="w3-tag w3-small w3-theme-d4">A-virtual</span>
